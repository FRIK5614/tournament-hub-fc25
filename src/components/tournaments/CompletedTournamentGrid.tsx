...
interface CompletedTournamentGridProps {
  tournaments: any[];
  loading: boolean;
  emptyMessage: string;
}

const CompletedTournamentGrid = ({ tournaments, loading, emptyMessage }: CompletedTournamentGridProps) => {
  if (loading) {
    return (
...
export default CompletedTournamentGrid;
